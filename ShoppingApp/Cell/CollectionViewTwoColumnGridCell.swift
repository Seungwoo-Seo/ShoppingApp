//
//  CollectionViewTwoColumnGridCell.swift
//  ShoppingApp
//
...
final class CollectionViewTwoColumnGridCell: UICollectionViewCell {
    static let identifier = "CollectionViewTwoColumnGridCell"
...
private extension CollectionViewTwoColumnGridCell {
